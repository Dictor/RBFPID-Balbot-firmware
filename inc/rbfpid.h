...
class RBFPID {
 private:
  ...
  double ym;                        // output of RBF NN
  double J;                         // jacobian information of RBF NN
 public:
  /**
   ...
   */
  RBFPID(int n, int m, double gain_mg, double init_kp, double init_ki, double init_kd,
         double u_limit, double init_rbf_width = 3.0,
